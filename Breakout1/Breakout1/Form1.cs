...
namespace Breakout1
{
    public partial class Form1 : Form
    {
        ...
        private void Draw(object sender, PaintEventArgs e)
        {
            ...
            SolidBrush yellowBrush = new SolidBrush(Color.Tomato);
            SolidBrush blueBrush = new SolidBrush(Color.DarkOliveGreen);

            float px = (float)this.ballPos.X - ballRadius;
            float py = (float)this.ballPos.Y - ballRadius;


            e.Graphics.FillEllipse(greenBrush, px, py, this.ballRadius * 2, this.ballRadius * 2);
            e.Graphics.FillRectangle(yellowBrush, paddlePos);
        ...
        private void KeyPressed(object sender, KeyPressEventArgs e)
        {
            ...
            else if(e.KeyChar=='l')//Lキーが押されたとき
             {
                this.paddlePos.X += 20;
            }
        }
